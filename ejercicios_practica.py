...
def fetch():
    ...
    query = c.execute  ('SELECT * FROM estudiante')
    for row in query :
        print (row)
...
def search_by_grade(grade):
    ...
    query = c.execute  ('SELECT * FROM estudiante where grade={}'.format(grade))
    for row in query :
        print (row)
...
def modify(id, name):
    ...
    print ("{} Fila(s) actualizada(s)".format(rowcount))
